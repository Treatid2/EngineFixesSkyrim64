...
#define EF_SETTINGS_MEMORYMANAGER(X)                                                                                                                                                                             \
    ...
    X(U32, uRenderPassSceneLights, 16, "published scene-light contract; vanilla 16, Native Mesh Light Flicker Fix 26; larger counts are truncated (clamped 16-64; storage remains 64 zeroed slots)")               \
