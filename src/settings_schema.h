...
#define EF_SETTINGS_FIXES(X)                                                                                                                                                                                                                                      \
    ...
    X(Bool, bMapMenuCloseHandlersNullGuard, true, "(VR-only) guards MapMenu::CloseHandlers' 5-slot input-handler teardown loop against a null or torn/not-yet-constructed handler pointer")
